...
* [Variable and Data Type](README.md)
  ...
  * [Reference Type](variable-and-data-type/reference-type/README.md)
    ...
    * [Function in Golang](variable-and-data-type/reference-type/function-in-golang/README.md)
      * [Function](variable-and-data-type/reference-type/function-in-golang/function.md)
      * [Function Init dan Main](variable-and-data-type/reference-type/function-in-golang/function-init-dan-main.md)
      * [Function vs Method](variable-and-data-type/reference-type/function-in-golang/function-vs-method.md)
      * [Function vs Procedure](variable-and-data-type/reference-type/function-in-golang/function-vs-procedure.md)
      * [Private vs Public Function](variable-and-data-type/reference-type/function-in-golang/private-vs-public-function.md)
      * [Function dengan Return Multiple Value](variable-and-data-type/reference-type/function-in-golang/function-dengan-return-multiple-value.md)
      * [Vardiac Function](variable-and-data-type/reference-type/function-in-golang/vardiac-function.md)
      * [Function as Parameter](variable-and-data-type/reference-type/function-in-golang/function-as-parameter.md)
      * [Function Type Declaration](variable-and-data-type/reference-type/function-in-golang/function-type-declaration.md)
      * [Anonymous Function](variable-and-data-type/reference-type/function-in-golang/anonymous-function.md)
      * [Function Input from CLI](variable-and-data-type/reference-type/function-in-golang/function-input-from-cli.md)
      * [Exercise (Function)](variable-and-data-type/reference-type/function-in-golang/exercise-function.md)
