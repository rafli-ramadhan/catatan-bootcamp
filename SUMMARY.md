...
* [Variable and Data Type](README.md)
  * [Primitive or Basic Variable](variable-and-data-type/primitive-or-basic-variable/README.md)
  ...
  * [Aggregate Type](variable-and-data-type/aggregate-type/README.md)
    * [Array](variable-and-data-type/aggregate-type/array.md)
    * [Struct, Embedded Struct, Struct Method](variable-and-data-type/aggregate-type/struct-embedded-struct-struct-method.md)
  ...
  * [Reference Type](variable-and-data-type/reference-type/README.md)
    * [Slice](variable-and-data-type/reference-type/slice/README.md)
      * [Slice Get Value from Array](variable-and-data-type/reference-type/slice/slice-get-value-from-array.md)
      * [Slice Add Value](variable-and-data-type/reference-type/slice/slice-add-value.md)
      * [Slice Update Value](variable-and-data-type/reference-type/slice/slice-update-value.md)
      * [Slice Delete Value](variable-and-data-type/reference-type/slice/slice-delete-value.md)
      * [Make Slice](variable-and-data-type/reference-type/slice/make-slice.md)
      * [Make Slice 2](variable-and-data-type/reference-type/slice/make-slice-2.md)
      * [Slice Length and Capactiy](variable-and-data-type/reference-type/slice/slice-length-and-capactiy.md)
    * [Map](variable-and-data-type/reference-type/map.md)
